...
export function setSelectedMode(mode) {
    const isImageMode = ['nano_banana_pro', 'nano_banana', 'nano_banana_2', 'fast_generation', 'z_image', 'qwen_image', 'qwen_image_edit', 'pixplace_pro', 'dreamshaper_xl', 'background_removal', 'upscale_image', 'print_maker', 'stickers'].includes(mode);
