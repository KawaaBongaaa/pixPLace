export const ru = {
    ...
    mode_print_maker: "Print on Demand",
    mode_photo_session: "Nano Banana Редактор Фото",
    mode_fast_generation: "Flux Fast быстрая генерация",
    mode_pixplace_pro: "Flux Pro Продвинутый",
    mode_details: "Инструкция по Режимам Генерации",

    // Новые описания режимов
    mode_photo_session_desc: "Лучший редактор Фотографий. Загрузите до 4 изображений в качестве референсов(примеров) и опишите что изменить, кого куда передвинуть и какой фон изобрзить",
    mode_fast_generation_desc: "Самый быстрый режим для базовой генерации изображений — выполняет обработку практически мгновенно. Без возможности загрузки своих изобржений в качестве референсов",
    mode_pixplace_pro_desc: "Профессиональный режим — предназначен для создания сложных макетов на уровне опытного дизайнера. Лого, инфографика, карточки товаров. Хорошо генерит только Английский текст (Русский текст даже не пробуйте). Есть возможность загружать ваши изображения в качестве референса",
