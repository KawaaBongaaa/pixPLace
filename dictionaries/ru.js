export const ru = {
    ...
    mode_photo_session_desc: "Идеально для фоторедактирования. Загрузите изображение и опишите что изменить",
    mode_fast_generation_desc: "Самый быстрый режим генерации простых картинок без загрузки изображений",
    mode_pixplace_pro_desc: "Продвинутый режим с поддержкой текста, логотипов и сложных композиций",
    mode_print_maker_desc: "Специально для Print on Demand. Создает готовые принты для одежды и аксессуаров",
    mode_background_removal_desc: "Убирает фон с изображения, сохраняя объект. Загрузите фотографию с объектом",
    mode_upscale_image_desc: "Улучшает качество и разрешение существующего изображения до 4K",
    size_label: "Размер",
    size_square: "1:1  ",
    size_portrait: "9:16",
    size_landscape: "16:9",
