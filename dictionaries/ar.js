export const ar = {
    ...
    error_server_overloaded: "😓 فشل في الإنشاء. الخادم محمل الآن، يرجى إعادة المحاولة لاحقًا أو اختيار وضع إنشاء آخر... نعتذر بشدة عن الإزعاج ونرجو تفهمك 🙏",
    success_generated: "تم إنشاء الصورة بنجاح!",
    copied_to_clipboard: "تم النسخ للحافظة",
    download_started: "بدأ التحميل",
    generation_queued: "تم إضافة الإنشاء إلى الطابور",
    generation_started: "بدأ الإنشاء",
    ...
    upgradeBtn: "ادفع",
    premium_limit_title: "استنفدت حد Premium الخاص بك!",
    premium_limit_message: "أعد الاستخدام مع الوظائف القياسية أو مدد للوصول الكامل.",
