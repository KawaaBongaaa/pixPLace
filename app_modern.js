...
import { initializeGlobalServices } from './core/services.js?v=2540';
import { AppStateManager } from './store/app-state.js?v=2540';
...
import { initUserAccount } from './user-account.js?v=2540';
