...
const TRANSLATIONS = {
    ...
    ru: {
        ...
        limit_message: 'Ваши кредиты закончились. Выберите тарифны план и Оформите подписку, чтобы продолжить! Оплатить можно с любой карты или криптой через телеграм сервис Tribute',
