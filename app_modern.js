...
const TRANSLATIONS = {
    ...
    ru: {
        ...
        limit_message: "Ваши кредиты закончились.\n\n[[b]]Больше кредитов[[/b]] Вы можете получить, оформив один из тарифных планов.\n\nОплатить можно [[i]]с любой карты или криптой[[/i]], быстро и легко, используя платежный сервис Tribute Telegram.",
