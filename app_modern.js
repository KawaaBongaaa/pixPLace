...
// Configuration
const CONFIG = {
    WEBHOOK_URL: 'YOUR_MAKE_WEBHOOK_URL_HERE', // ⚠️ ЗАМЕНИТЕ НА ВАШ WEBHOOK!
...
const TRANSLATIONS = {
    ...
    ru: {
        loading: 'Загрузка...',
        app_title: 'ИИ Генератор',
        connecting: 'Подключение...',
        connected: 'Подключено к Telegram',
        welcome_title: 'Создавайте Потрясающие Изображения',
        welcome_subtitle: 'Опишите свое видение и наблюдайте, как ИИ воплощает его в жизнь',
...
document.addEventListener('DOMContentLoaded', async function() {
    console.log('🚀 Modern AI Generator starting...');
...
console.log('🎯 Modern AI Generator loaded!');
