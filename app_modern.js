...
const TRANSLATIONS = {
    ...
    en: {
        ...
        style_banner: 'Banner',
        mode_label: 'Mode',
        mode_background_removal: 'BackGround Removal | img2img | ~1cr',
        mode_upscale_image: 'Upscale Image | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img | ~2cr',
        mode_photo_session: 'Photo Session | Kontext Model | img2img | ~5cr',
        mode_fast_generation: 'Fastest | Simple Pictures | txt2img | ~1cr',
    ...
    ru: {
        ...
        style_banner: 'Баннер',
        mode_label: 'Режим',
        mode_background_removal: 'Удаление фона | img2img | ~1cr',
        mode_upscale_image: 'Улучшение качества | img2img',
        mode_print_maker: 'Печать | Sticker | POD Helper | txt2img ~2cr',
        mode_photo_session: 'ФотоCессия | Kontext Model | img2img | ~5cr',
        mode_fast_generation: 'Быстрая Генерац | Простые картинки | txt2img | ~1cr',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img ~5cr',
        size_label: 'Размер',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        limit_message: "Ваши кредиты закончились.\nБольше кредитов[[/b]] Вы можете получить, оформив один из тарифных планов.\nОплатить можно с любой карты или криптой, быстро и легко, используя платежный сервис Tribute Telegram.",
        check_subsciption: 'Проверить подписку',
        closeLimitModal: 'Может позже',
        upgradeBtn: 'Выбрать тариф',
        remove_user_image: 'Удалить',
        upload_image: 'Загрузить изображение',
        please_upload_photo_session: 'Лля Режима Фотосессии необходимо Загрузить фото с Лицом! Или выбери другой Режим Генерации',
    ...
    es: {
        ...
        style_banner: 'Banner',
        mode_label: 'Modo',
        mode_background_removal: 'Eliminación de fondo | img2img',
        mode_upscale_image: 'Aumentar resolución | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'Sesión de fotos | Kontext Model | img2img',
        mode_fast_generation: 'Más rápido | Imágenes simples | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'Tamaño',
        size_square: '1:1',
        size_portrait: '9:16',
        size_landscape: '16:9',
        ...
        optional_choice: '(opcional)',
        upload_image: 'Subir Img'
    },
    ...
    fr: {
        ...
        mode_label: 'Mode',
        mode_background_removal: 'Suppression de fond | img2img',
        mode_upscale_image: 'Amélioration de l’image | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'Séance photo | Kontext Model | img2img',
        mode_fast_generation: 'Le plus rapide | Images simples | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'Taille',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        limit_message: 'Limite gratuite atteinte. Passez à l’abonnement pour continuer !',
        check_subsciption: 'Vérifier l’abonnement',
        closeLimitModal: 'Plus tard',
        upgradeBtn: 'Mettre à niveau',
        remove_user_image: 'Supprimer',
        reference_image: 'Référence',
        optional_choice: '(optionnel)',
        upload_image: 'Téléverser Img'
    },
    ...
    de: {
        ...
        style_banner: 'Banner',
        mode_label: 'Modus',
        mode_background_removal: 'Hintergrund entfernen | img2img',
        mode_upscale_image: 'Hochskalieren | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'Fotosession | Kontext Model | img2img',
        mode_fast_generation: 'Am schnellsten | Einfache Bilder | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'Größe',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        processing_title: 'Dein Meisterwerk entsteht',
        ...
        limit_message: 'Kostenloses Limit erreicht. Upgrade, um fortzufahren!',
        check_subsciption: 'Abo prüfen',
    ...
    zh: {
        ...
        welcome_subtitle: '描述你的愿景，看 AI 将其变为现实',
        prompt_label: '提示词',
        ...
        style_banner: '横幅',
        mode_label: '模式',
        mode_background_removal: '背景移除 | img2img',
        mode_upscale_image: '图像放大 | img2img',
        mode_print_maker: '打印 | Sticker | POD Helper | txt2img',
        mode_photo_session: '拍摄会 | Kontext Model | img2img',
        mode_fast_generation: '最快 | 简单图片 | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: '尺寸',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        processing_subtitle: '这可能需要最长 60 秒',
        ...
        empty_history_subtitle: '创建你的第一张 AI 图像后可在此查看',
        ...
        limit_title: '已达生成上限',
        limit_message: '已达到免费生成上限。升级以继续！',
        check_subsciption: '检查订阅',
        closeLimitModal: '稍后再说',
        upgradeBtn: '立即升级',
        remove_user_image: '删除',
        reference_image: '参考',
        optional_choice: '（可选）',
        upload_image: '上传图片'
    },
    ...
    pt: {
        ...
        style_banner: 'Banner',
        mode_label: 'Modo',
        mode_background_removal: 'Remoção de fundo | img2img',
        mode_upscale_image: 'Upscale de imagem | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'Sessão de fotos | Kontext Model | img2img',
        mode_fast_generation: 'Mais rápido | Imagens simples | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'Tamanho',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        processing_subtitle: 'Pode levar até 60 segundos',
        ...
        empty_history_subtitle: 'Crie sua primeira imagem de IA para vê-la aqui',
        generation_time: 'Tempo de geração',
        error_prompt_required: 'Descreva sua imagem',
        ...
        limit_message: 'Você atingiu seu limite gratuito. Atualize para continuar!',
    ...
    ar: {
        ...
        style_banner: 'لافتة',
        mode_label: 'الوضع',
        mode_background_removal: 'إزالة الخلفية | img2img',
        mode_upscale_image: 'تحسين الدقة | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'جلسة تصوير | Kontext Model | img2img',
        mode_fast_generation: 'الأسرع | صور بسيطة | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'الحجم',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        error_webhook_not_configured: 'Webhook غير مكوّن',
        error_generation_failed: 'فشل التوليد',
        error_timeout: 'انتهت المهلة. حاول مجددًا.',
        success_generated: 'تم إنشاء الصورة بنجاح!',
        copied_to_clipboard: 'تم النسخ إلى الحافظة',
        download_started: 'بدأ التنزيل',
        limit_title: 'تم بلوغ الحد',
        limit_message: 'وصلت للحد المجاني. قم بالترقية للمتابعة!',
        ...
        optional_choice: '(اختياري)',
        upload_image: 'رفع صورة'
    },

    hi: {
        loading: 'मज़े के साथ बनाएं!',
        app_title: 'pixPLace',
        connecting: 'कनेक्ट हो रहा है...',
        connected: 'Telegram से जुड़ गया',
        welcome_title: 'शानदार छवियाँ बनाएं',
        welcome_subtitle: 'अपनी कल्पना बताएं और देखें AI उसे जीवन देता है',
        prompt_label: 'प्रॉम्प्ट',
        prompt_placeholder: 'समुद्र पर सुंदर सूर्यास्त...',
        style_label: 'शैली',
        ...
        style_banner: 'बैनर',
        mode_label: 'मोड',
        mode_background_removal: 'पृष्ठभूमि हटाना | img2img',
        mode_upscale_image: 'अपस्केल इमेज | img2img',
        mode_print_maker: 'प्रिंट | Sticker | POD Helper | txt2img',
        mode_photo_session: 'फोटो सेशन | Kontext Model | img2img',
        mode_fast_generation: 'सबसे तेज़ | सरल चित्र | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'आकार',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        processing_title: 'आपकी उत्कृष्ट कृति बन रही है',
        ...
        empty_history_title: 'अभी कोई जनरेशन नहीं',
        ...
        error_timeout: 'समय सीमा समाप्त। पुनः प्रयास करें।',
        success_generated: 'छवि सफलतापूर्वक बनी!',
        copied_to_clipboard: 'क्लिपबोर्ड पर कॉपी किया गया',
        download_started: 'डाउनलोड शुरू हुआ',
        limit_title: 'सीमा पूरी हुई',
        limit_message: 'मुफ़्त सीमा पूरी। जारी रखने के लिए अपग्रेड करें!',
        check_subsciption: 'सदस्यता जाँचें',
        closeLimitModal: 'शायद बाद में',
        upgradeBtn: 'अभी अपग्रेड करें',
        remove_user_image: 'हटाएँ',
        reference_image: 'रेफ़रेंस',
        optional_choice: '(वैकल्पिक)',
        upload_image: 'Img अपलोड'
    },
    ...
    ja: {
        ...
        welcome_subtitle: 'ビジョンを説明し、AIが実現する様子を見ましょう',
        prompt_label: 'プロンプト',
        ...
        style_banner: 'バナー',
        mode_label: 'モード',
        mode_background_removal: '背景除去 | img2img',
        mode_upscale_image: '高解像度化 | img2img',
        mode_print_maker: 'プリント | Sticker | POD Helper | txt2img',
        mode_photo_session: 'フォトセッション | Kontext Model | img2img',
        mode_fast_generation: '最速 | シンプル画像 | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'サイズ',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        limit_message: '無料制限に達しました。アップグレードして続行！',
        check_subsciption: 'サブスクリプション確認',
        closeLimitModal: '後で',
        upgradeBtn: '今すぐアップグレード',
        remove_user_image: '削除',
        reference_image: 'リファレンス',
        optional_choice: '(任意)',
    ...
    it: {
        ...
        style_banner: 'Banner',
        mode_label: 'Modalità',
        mode_background_removal: 'Rimozione sfondo | img2img',
        mode_upscale_image: 'Upscale immagine | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'Sessione fotografica | Kontext Model | img2img',
        mode_fast_generation: 'Il più veloce | Immagini semplici | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        ...
        error_prompt_too_short: 'Prompt troppo breve (min. 5 caratteri)',
        ...
        limit_message: 'Hai raggiunto il limite gratuito. Aggiorna per continuare!',
        check_subsciption: 'Controlla abbonamento',
        closeLimitModal: 'Forse più tardi',
        upgradeBtn: 'Aggiorna ora',
        remove_user_image: 'Rimuovi',
        reference_image: 'Referenza',
        optional_choice: '(opzionale)',
        upload_image: 'Carica Img'
    },
    ...
    ko: {
        ...
        welcome_subtitle: '비전을 설명하면 AI가 현실로 만듭니다',
        prompt_label: '프롬프트',
        ...
        style_banner: '배너',
        mode_label: '모드',
        mode_background_removal: '배경 제거 | img2img',
        mode_upscale_image: '업스케일 | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: '포토 세션 | Kontext Model | img2img',
        mode_fast_generation: '가장 빠름 | 간단한 이미지 | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: '크기',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        step_analyzing: '프롬프트 분석',
        step_generating: '이미지 생성',
        step_finalizing: '마무리',
        elapsed_time: '경과 시간:',
        cancel_btn: '취소',
        create_new: '새로 만들기',
        view_history: '기록 보기',
        history_title: '생성 기록',
        empty_history_title: '아직 생성 기록이 없습니다',
        empty_history_subtitle: '첫 AI 이미지를 생성하여 여기에서 확인하세요',
        ...
        success_generated: '성공적으로 생성되었습니다!',
        copied_to_clipboard: '클립보드에 복사됨',
        download_started: '다운로드 시작',
        limit_title: '생성 한도 도달',
        limit_message: '무료 한도에 도달했습니다. 업그레이드하여 계속하세요!',
        check_subsciption: '구독 확인',
        closeLimitModal: '나중에',
        upgradeBtn: '지금 업그레이드',
        remove_user_image: '제거',
        reference_image: '레퍼런스',
        optional_choice: '(선택 사항)',
    ...
    tr: {
        ...
        welcome_subtitle: 'Vizyonunuzu anlatın, yapay zekâ onu gerçeğe dönüştürsün',
        prompt_label: 'Prompt',
        prompt_placeholder: 'Okyanus üzerindeki güzel bir gün batımı...',
        style_label: 'Stil',
        ...
        style_banner: 'Banner',
        mode_label: 'Mod',
        mode_background_removal: 'Arka plan kaldırma | img2img',
        mode_upscale_image: 'Görüntü büyütme | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'Fotoğraf çekimi | Kontext Model | img2img',
        mode_fast_generation: 'En hızlı | Basit görseller | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'Boyut',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        empty_history_subtitle: 'İlk yapay zekâ görselinizi oluşturun',
        ...
        limit_title: 'Limit aşıldı',
        limit_message: 'Ücretsiz limitinize ulaştınız. Yükseltin ve devam edin!',
    ...
    pl: {
        ...
        welcome_subtitle: 'Opisz swoją wizję i zobacz, jak AI ożywia ją',
        prompt_label: 'Prompt',
        ...
        style_banner: 'Baner',
        mode_label: 'Tryb',
        mode_background_removal: 'Usuwanie tła | img2img',
        mode_upscale_image: 'Skalowanie obrazu | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'Sesja zdjęciowa | Kontext Model | img2img',
        mode_fast_generation: 'Najszybsze | Proste obrazki | txt2img',
        mode_pixplace_pro: 'pixPLace Pro | Logo | Text | img2img',
        size_label: 'Rozmiar',
        size_square: '1:1',
        size_portrait: '9:16',
        ...
        step_analyzing: 'Analiza promptu',
        step_generating: 'Generowanie obrazu',
        step_finalizing: 'Finalizacja wyniku',
        ...
        empty_history_subtitle: 'Stwórz swój pierwszy obraz AI',
        generation_time: 'Czas generacji',
        error_prompt_required: 'Opisz swój obraz',
        error_prompt_too_short: 'Zbyt krótki prompt (min. 5 znaków)',
        error_webhook_not_configured: 'Webhook nie skonfigurowany',
        error_generation_failed: 'Generacja nie powiodła się',
        error_timeout: 'Przekroczono limit czasu. Spróbuj ponownie.',
        success_generated: 'Obraz wygenerowano pomyślnie!',
        copied_to_clipboard: 'Skopiowano do schowka',
        download_started: 'Rozpoczęto pobieranie',
        limit_title: 'Limit osiągnięty',
        limit_message: 'Osiągnięto darmowy limit. Ulepsz, aby kontynuować!',
