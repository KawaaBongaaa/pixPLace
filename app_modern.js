...
const TRANSLATIONS = {
    en: {
        ...
        style_banner: 'Banner',
        mode_label: 'Mode',
        mode_background_removal: 'BackGround Removal | img2img',
        mode_upscale_image: 'Upscale Image | img2img',
        mode_print_maker: 'Print | Sticker | POD Helper | txt2img',
        mode_photo_session: 'Photo Session | Kontext Model | img2img',
        mode_fast_generation: 'Fastest | Simple Pictures | txt2img',
